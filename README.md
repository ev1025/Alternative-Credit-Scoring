...
### 프로젝트 기간
- 2024년 12월 27일 ~ 2025년 1월 8일 (휴일 제외 약 5일)
...
#### 데이터 소개 
&nbsp; 서울시와 SK텔레콤이 공공빅데이터와 통신데이터를 가명 결합하여 추정한 데이터로, 서울 행정동 단위 성·연령별 1인 가구 및 서울시민의 생활 특성 정보를 제공  
...
#### 데이터 소개  
&nbsp; 금융 AI 학습 및 데이터 분석에 활용할 수 있도록, 금융기관으로부터 획득한 데이터의 특성을 인공지능 알고리즘으로 학습해 생성한 합성 데이터
